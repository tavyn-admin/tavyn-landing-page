  ...
  return (
    ...
    >
      <section style={{ maxWidth: 460, textAlign: "center" }}>
        <h1 style={{ margin: "0 0 12px", fontSize: 24, fontWeight: 700, letterSpacing: 0 }}>SERP report not found</h1>
        ...
        <Link href="/" className="tv-link" style={{ fontSize: 13, fontWeight: 600 }}>
          Back to home
        </Link>
      </section>
    </main>
