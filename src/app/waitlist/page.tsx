...
export default function WaitlistPage() {
    ...
    const showWebsiteError =
        (websiteTouched || attemptedSubmit) && !websiteValid(website);
        ...
        >
                                ...
                                style={{
                                    ...
                                    cursor: submitting
                                        ...
                                        : valid
                                          ...
                                          : 'not-allowed',
                                    transition:
                                        'left 320ms cubic-bezier(0.4,0,0.2,1), width 320ms cubic-bezier(0.4,0,0.2,1), opacity 260ms ease',
                                    overflow: 'hidden',
                                }}
                            >
                    ...
                    style={{
                        ...
                        clipPath:
                            mode === 'fill'
                                ...
                                : 'none',
                        transition:
                            'clip-path 900ms cubic-bezier(0.4,0,0.2,1), opacity 550ms ease',
                        pointerEvents: 'none',
                        zIndex: 30,
                    }}
                />
            ...
            {mode === 'thanks' && (
                <ThankYouView
                    ...
                    onBack={() =>
                        router.push(
                            isSerpLeadMagnet && serpReturnPath
                                ? serpReturnPath
                                : '/',
                        )
                    }
            ...
            >
                <span
                    style={{
                        fontSize: TEXT_SIZE,
                        letterSpacing: TEXT_LS,
                        color: value ? COLORS.text : PLACEHOLDER,
                        whiteSpace: 'nowrap',
                    }}
                >
                    {value ?? 'Industry'}
        ...
        >
            ...
            <span
                ...
                style={{
                    ...
                    background: checked
                        ? 'linear-gradient(to right, #FF7400, #FF0000)'
                        : 'transparent',
                    display: 'flex',
                    alignItems: 'center',
    ...
    return (
        <>
            ...
            <button
                onClick={onBack}
                aria-label={
                    isSerpLeadMagnet ? 'Back to SERP audit' : 'Back to home'
                }
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <path
                                    d="M8 18.8 L14.4 25.2 L28.5 10.8"
                                    stroke="url(#waitlist-check-gradient)"
                                    strokeWidth="3.2"
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
                                />
                        ...
                        >
                            You&rsquo;ve taken the first step toward turning
                            search into a growth channel.
                        </p>
