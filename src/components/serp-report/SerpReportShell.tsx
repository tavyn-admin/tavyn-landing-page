...
import SerpTelemetryProvider from '@/components/serp-report/SerpTelemetryProvider';
...
export default function SerpReportShell({
    auditSlug,
    reportData,
}: SerpReportShellProps) {
    return (
        <SerpTelemetryProvider auditSlug={auditSlug}>
            <main className={styles.theme}>
                ...
                <SerpReportSection
                    telemetryId="company_product_profile"
                    telemetryIndex={1}
                >
                ...
                <SerpReportSection
                    telemetryId="analysis_scope"
                    telemetryIndex={2}
                >
                    <AnalysisScope
                        analysisCoverage={reportData.analysisScope}
                    />
                </SerpReportSection>

                <SerpReportSection
                    telemetryId="query_analysis"
                    telemetryIndex={3}
                >
                    <QueryAnalysis
                ...
                <div id="competitor-landscape" style={{ scrollMarginTop: 96 }}>
                    <SerpReportSection
                        telemetryId="competitor_landscape"
                        telemetryIndex={4}
                    >
                        <CompetitorLandscape
                ...
                <div className={styles.closingSequence}>
                    ...
                    >
                        <ReportCta
                            ...
                            recommendations={
                                reportData.contentPlan.recommendations
                            }
                        />
                    </SerpReportSection>
                </div>
            </main>
        </SerpTelemetryProvider>
    );
}
