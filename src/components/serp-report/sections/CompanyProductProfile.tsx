  ...
  return (
    <div className={pageStyles.page}>
      <header className={pageStyles.header}>
        <h1 className={pageStyles.title}>{possessiveCompanyName} Company and Product Profile</h1>
      ...
      <div className={pageStyles.primaryContent}>
        ...
        <section className={pageStyles.keySummary} aria-labelledby="company-product-profile-summary">
