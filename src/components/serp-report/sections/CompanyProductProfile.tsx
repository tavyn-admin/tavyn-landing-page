  ...
  return (
    <div ref={rootRef} className={`${pageStyles.page} ${styles.root}`}>
      <header className={`${pageStyles.header} ${styles.profileHeader}`}>
        ...
        <p className={`${pageStyles.subtitle} ${styles.profileDescription}`}>
      ...
      <div className={pageStyles.primaryContent}>
        <div className={styles.content}>
          <div className={styles.topCards}>
            <section className={`${styles.card} ${styles.productCard}`} aria-labelledby="company-product-profile-product">
            ...
            <section className={`${styles.card} ${styles.audienceCard}`} aria-labelledby="company-product-profile-audience">
              <div className={styles.sectionHeader}>
                <img className={styles.sectionIndicator} src={sectionIndicatorSrc} alt="" aria-hidden="true" />
        ...
        >
          <h2 id="company-product-profile-summary" className={styles.insightTitle}>
